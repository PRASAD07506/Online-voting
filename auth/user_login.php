    ...
    <div class="card glass-card auth-card auth-shell-card elevate-hover interactive-panel" data-landing-shell>
        ...
        <div class="card-body p-4 p-md-5 position-relative">
            ...
            <form method="POST" class="auth-login-grid">
                ...
                <button class="btn btn-primary w-100 py-2 landing-action" name="login">User Login</button>
            </form>
            ...
            <div class="text-center mt-2">
                <a href="admin_login.php" class="text-decoration-none">Go to Admin Login</a>
            </div>
        </div>
    </div>
</div>
